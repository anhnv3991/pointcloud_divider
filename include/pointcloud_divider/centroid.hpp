...
template <>
void compute_centroid(const pcl::PointXYZ & acc_diff, const pcl::PointXYZ & first_p, size_t point_num, pcl::PointXYZ & centroid)
{
...
template <>
void compute_centroid(const pcl::PointXYZI & acc_diff, const pcl::PointXYZI & first_p, size_t point_num, pcl::PointXYZI & centroid)
{
    double double_point_num = static_cast<double>(point_num);
